<?php
	...
	if (isset($_POST["name"])):
		$search = $_POST["name"];
		$query = "SELECT * FROM PLAYERS INNER JOIN PROFILE_PICTURES WHERE PLAYERS.USERNAME LIKE '%$search%' AND PLAYERS.IDPLAYER = PROFILE_PICTURE.IDPLAYER ORDER BY FIRST_NAME";
	else:
