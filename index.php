		...
		<div class="row">
			<div class="col-md-5">
				<div class="maxAlt">
					...
					<p class="sizeText_S2 p">Disponibilizamos a criação de tabelas para diversos jogos. Independente se é PC, Xbox ou Playstation. Além disso temos as modalidades mata-mata e pontos corridos.</p>
				</div>
			</div>
			<div class="col-md-7">
				<div class="imgFade">
...
<br><br><br>
	...
	<section class="footers pt-5 pb-3 CorBack1">
		...
		<section class="copyright border CorBack">
			<div class="container">
				<div class="row text-center">
					<div class="col-md-12 pt-3">
						<p class="CorText">© 2019 WinnChay Ltd.</p>
					</div>
				</div>
			</div>
		</section>
